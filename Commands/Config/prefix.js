...
module.exports = {
   ...
   if (message.member.hasPermission("ADMINITARTOR")) return message.channel.send(`You don't have the required Permissions!`)
   ...
   const data = prefixModel.findOne({ GuildID: message.guild.send })
