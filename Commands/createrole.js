...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) {
        return message.channel.send("Usage: `createrole <color> <name>`. If your color name contains multiple words, dont use space between them. e.g Spring Green, Correct Usage: `springgreen`")
        }
        if (!name) {
